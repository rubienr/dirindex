...
class FileType:
    def __init__(self, absolute_path="", absolute_path_hash_tag="", relative_path_hash_tag="", relative_path="",
                 filename="", file_extension="", hash_tag="", file_size="", last_modified_time="", creation_time=""):
